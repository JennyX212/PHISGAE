...
for gene in genes_seq.keys():
  genes_kmers[gene] = summary_kmers(build_kmers(seq=genes_seq[gene], k_size=7))
...
kmers_freq_frame.to_csv("../data/DNA_f/onlykmers/k_7/phage_kmers.csv",index = True, sep=',',header = True,na_rep='0')
